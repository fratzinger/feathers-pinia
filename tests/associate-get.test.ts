...
import { BaseModel, associateGet, type Params, useService } from '../src/index' // from 'feathers-pinia'
...
const useMessagesService = defineStore('messages', () => ({ servicePath: 'messages', Model: Message, app: api }))
